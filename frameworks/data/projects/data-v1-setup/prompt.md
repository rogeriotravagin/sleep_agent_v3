...
Criar o Data Intelligence Expansion Pack com 6 agents especializados (clones de experts reais) e tasks operacionais para análise de dados de negócio.
...
```
expansion-packs/data/docs/framework/
...
Seguir estrutura do expansion-packs/copy/agents/:
...
jq --arg id "DATA-XXX" --arg notes "Completed: N frameworks, M signature phrases, X linhas" \
  ...
  expansion-packs/data/projects/data-v1-setup/prd.json > tmp.json && mv tmp.json expansion-packs/data/projects/data-v1-setup/prd.json
```
